...
def main():
    ...
    SG_data = torch.load(
        f"/data1/zonglin/SG-Unlearn/result/SG_data_cifar100-30epoch/SGdata_seed_{args.seed}_{args.dataset}.pth"
    )  # TODO:
    ...
    if args.dataset == "cifar10":
        local_path = (
            "/data1/zonglin/SG-Unlearn/models/cifar10_resnet18_ckpt.pth"  # TODO:
        )
    elif args.dataset == "cifar100":
        local_path = (
            "/data1/zonglin/SG-Unlearn/models/cifar100_resnet18_ckpt_native.pth"
        )
