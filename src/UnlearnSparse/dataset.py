...
def cifar10_dataloaders_no_val(batch_size=128, data_dir='data/', num_workers=2):
...
def cifar100_dataloaders_no_val(batch_size=128, data_dir='datasets', num_workers=2):
...
def cifar10_dataloaders(batch_size=128, data_dir='data/', num_workers=2, class_to_replace: int = None, num_indexes_to_replace=None, indexes_to_replace=None, seed: int = 1, only_mark: bool = False, shuffle=True, no_aug=False):
