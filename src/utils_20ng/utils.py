...
def load_data(dataset_str):
    ...
    for i in range(len(names)):
        with open(
            "/data1/zonglin/CSE-842-proj/data/ind.{}.{}".format(dataset_str, names[i]),
            "rb",
        ) as f:
    ...
    test_idx_reorder = parse_index_file(
        "/data1/zonglin/CSE-842-proj/data/ind.{}.test.index".format(dataset_str)
    )
...
def load_corpus(dataset_str):
    ...
    for i in range(len(names)):
        with open(
            "/data1/zonglin/SG-Unlearn/20ng/ind.{}.{}".format(dataset_str, names[i]),
            "rb",
        ) as f:
            if sys.version_info > (3, 0):
                objects.append(pkl.load(f, encoding="latin1"))
    ...
    train_idx_orig = parse_index_file(
        "/data1/zonglin/SG-Unlearn/20ng/{}.train.index".format(dataset_str)
    )
